...
public class Update_Doctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.doctorUpdateTvEmailAddress.setText(doctor.getSpecialization());
            ...
            public void onClick(View v) {
                if (imageUri == null){
                    Doctor doctor1 = new Doctor(
                            ...
                            true);
                    Toast.makeText(Update_Doctor.this, loadUid()+"   uid", Toast.LENGTH_SHORT).show();
                    Firebase_Function.addToRealTime(doctor , Update_Doctor.this , loadUid() );
                    updateDoctor(doctor1);
        ...
        if (imageUri != null) {
            ...
            uploadTask.addOnSuccessListener(taskSnapshot -> {
                ref.getDownloadUrl().addOnSuccessListener(uri -> {
                    ...
                    Firebase_Function.addToRealTime(doctor2 , Update_Doctor.this , loadUid());
