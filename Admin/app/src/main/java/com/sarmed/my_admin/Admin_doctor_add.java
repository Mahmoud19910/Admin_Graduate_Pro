...
Doctor doctor ;
    ...
    public  void uploadImage() {
        if (imageUri != null) {
            ...
            StorageReference ref = storageReference.child("doctor/" + UUID.randomUUID().toString());
            ...
            uploadTask.addOnSuccessListener(taskSnapshot -> {
                ref.getDownloadUrl().addOnSuccessListener(uri -> {
                    ...
                    Toast.makeText(Admin_doctor_add.this, "Image Uploaded!!", Toast.LENGTH_SHORT).show();
                    ...
                    doctor = new Doctor(
                            ...
                            binding.doctorAddTvADescription.getText().toString(), true);


                    Firebase_Function.addToRealTime(doctor , Admin_doctor_add.this , loadUid());
                    savePhot(doctor.getImage());
    ...
    public void savePhot(String photo){
